  ...
  if(myid==1)then
     ...
     if (to_file .eqv. .true.) then
        ...
        if(IOGROUPSIZEREP>0)then
           ...
           fileloc1='output_'//TRIM(nchar)//'/group_'//TRIM(ncharcpu)//'/clump_info.txt'
           fileloc2='output_'//TRIM(nchar)//'/group_'//TRIM(ncharcpu)//'/clump_masses.txt'
        else
           fileloc1='output_'//TRIM(nchar)//'/clump_info.txt'
           fileloc2='output_'//TRIM(nchar)//'/clump_masses.txt'
        endif

        open(unit=20,file=TRIM(fileloc1),form='formatted')
        open(unit=21,file=TRIM(fileloc2),form='formatted')
     end if
     if(smbh)then
...
subroutine write_clump_map(ntest)
  ...
  if(IOGROUPSIZEREP>0)then
     call title(((myid-1)/IOGROUPSIZEREP)+1,ncharcpu)
     fileloc='output_'//TRIM(nchar)//'/group_'//TRIM(ncharcpu)//'/clump_map.csv'//myidstring
  else
     fileloc='output_'//TRIM(nchar)//'/clump_map.csv'//myidstring
  endif
